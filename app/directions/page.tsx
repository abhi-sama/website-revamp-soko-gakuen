    ...
    <div className="bg-[#fafaf7] min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="text-sm text-gray-500 mb-6" aria-label="Breadcrumb">
          ...
          <span className="text-gray-900">Directions</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl">
          ...
          <div className="space-y-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-md text-sm font-medium text-white transition-colors"
          ...
          {/* Map embed */}
          <div className="rounded-lg overflow-hidden shadow-sm border border-gray-200 bg-gray-100 min-h-[300px] flex flex-col items-center justify-center">
            <iframe
